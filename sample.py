    ...
    def on_data(self, raw_data):
        ...
        if self.counter==self.limit:
            ...
            sw=[
                ...
                'off', 'above','@',',','!',',''','.',',','"','-','+','-',')','(','&','>','<','#','%','^','&',
                '*','[',']','{','}','?','~','`','a','an','the','have','has','had','may','might','would','could',
                'should','ought','it','i','other','are',"aren't",'so','all','who','you','me','she','her','it',
                'they','them','us','there','your','was','that','and','is','not','why','what','whose','no','yes'
                'went','came','got','1','2','3','4','5','6','7','8','9','0','will','be','again','doing','if',
                'because','but','soom','am','than','more','less','use','used','he','him','she','her','every','body',
                'thing','free','we','just','been','or'
            ]
